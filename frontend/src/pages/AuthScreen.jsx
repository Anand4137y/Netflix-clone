...
const handleFormSubmit = (e) => {
  ...
  return (
    <div className='hero-bg relative '>
        ...
        {/* Left side */}
        <div className="flex-1 text-center md:text-xl">
                ...
                {/* left side */}
                    <div className='flex-1 relative '>
                        <div className='relative'>
                            ...
                            className='mt-4'
                            />
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:1/2 h-20 border-slate-500 rounded-md px-2'> 
